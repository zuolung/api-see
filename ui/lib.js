...
export function ApiUi(props) {
  ...
  const setActiveHeader = useCallback(function (index, target) {
    active[target] = index;
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "api-body"
  }, api && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    className: "api-title"
  }, api.description), /*#__PURE__*/React.createElement("div", {
    className: "api-row"
  }, /*#__PURE__*/React.createElement("span", null, "\u5730\u5740\uFF1A"), /*#__PURE__*/React.createElement("span", {
    className: "api-url",
    onClick: () => window.open(`http://localhost:${mockPort}${api.url}`)
